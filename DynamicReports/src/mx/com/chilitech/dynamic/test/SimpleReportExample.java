package mx.com.chilitech.dynamic.test;
...
public class SimpleReportExample {
	...
	public static void main(String[] args) {
		...
		String headerImagePath = "C:\\Users\\Hitss\\Desktop\\logo.gif";
		...
		report
		  ...
		  .title(Components.verticalList().add(Components.image(img).setFixedDimension(500, 400)));
